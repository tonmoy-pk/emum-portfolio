  ...
  <div class="flex relative gap-[100px] homepage-body-container px-[240px] py-[32px] desk1:px-[140px] mob:px-[16px] mob:py-[64px] mob:flex-col mob:gap-[32px]">
    <div class="mob:hidden tab:hidden desk3:hidden desk2:hidden icon-container absolute left-[7.5rem] top-[330px]">
      <ul class="flex gap-[24px] flex-col items-center">
          ...
          >
            <g clip-path="url(#clip0_354_1800)">
              <path
                ...
                fill="#6F6F6F"
                class="dark:fill-[#D7D8DD] hover:fill-[#1877F2] dark:hover:fill-[#1877F2]"
              />
            </g>
            <defs>
              <clipPath id="clip0_354_1800">
                <rect
                  ...
                  height="24"
                  fill="white"
                  class="hover:fill-[#1877F2] dark:hover:fill-white"
                />
              </clipPath>
            </defs>
          </svg>
        ...
        <li class="cursor-pointer">
          ...
          >
            <path
              ...
              fill="#6F6F6F"
              class="dark:fill-[#D7D8DD] hover:fill-[#1DA1F2] dark:hover:fill-[#1DA1F2]"
            />
          </svg>
        </li>
        <li class="cursor-pointer">
          ...
          >
            <path
              ...
              fill="#262626"
              class="dark:fill-[#D7D8DD] hover:fill-[#FCAF45]"
            />
            <path
        ...
        <li class="cursor-pointer hover:linked-in">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            width="24"
            height="24"
          ...
          >
            <path
              ...
              fill="#262626"
              class="dark:fill-[#D7D8DD] dark:hover:fill-[#0077B5]"
            />
          </svg>
        </li>
        <li class="svg-arrow">
