...
<template>
  <div class="text-[#262626] dark:text-[#D7D8DD] flex justify-center px-[240px] py-[80px] gap-[32px] mob:px-[16px] mob:py-[64px] mob:gap-[16px] mob:flex-col">
    ...
    <div class="flex-col flex w-[366px] p-[32px] items-start gap-[24px] mob:w-auto mob:gap-[16px] mob:p-[16px]">
      <div class="flex items-center p-[10px] mob:p-0">
        <span class="leading-[32px] text-[48px] dark:text-[#D7D8DD] font-bold mob:text-[24px] mob:leading-[32px]">
          Contact Info
        </span>
      </div>
      <div class="flex flex-col gap-[16px] dark:text-[#D7D8DD]">
